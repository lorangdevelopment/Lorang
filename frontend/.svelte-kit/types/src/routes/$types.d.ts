...
type LayoutRouteId = RouteId | '/a/[slug]' | '/k/[permalink]' | '/[[permalink]]' | null;
type LayoutParams = RouteParams & { slug?: string; permalink?: string };
...
export type LayoutServerData = Expand<
	OptionalUnion<
		EnsureDefined<
			Kit.LoadProperties<Awaited<ReturnType<typeof import('./proxy+layout.server.js').load>>>
		>
	>
>;
